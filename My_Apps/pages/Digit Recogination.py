...
if input_mode == "Real-Time Live Camera 📹":
    ...
    st.info(
        "Hold a handwritten digit up to your webcam. The model will continuously draw predictions over the video."
    )
    ...
    uploaded_file = st.file_uploader(
        "Upload a handwritten digit picture...", type=["jpg", "jpeg", "png"]
    )
    ...
    if uploaded_file is not None:
        ...
        with col2:
            ...
            st.write("**Probability breakdown across digits (0–9):**")
